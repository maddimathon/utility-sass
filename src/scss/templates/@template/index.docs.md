...
```scss
@forward 'pkg:@maddimathon/utility-sass/templates/PLACEHOLDER/config' with (
    ...
);
```
...
```scss
@forward 'pkg:@maddimathon/utility-sass/templates/PLACEHOLDER/tokens' with (
    ...
);
```
...
@forward 'pkg:@maddimathon/utility-sass/templates/PLACEHOLDER';
...
@use 'pkg:@maddimathon/utility-sass/templates/PLACEHOLDER' as lib;
