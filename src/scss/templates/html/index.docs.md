...
Forwards the package's [global template](../global/index.docs.md).
...
```scss
@forward 'pkg:@maddimathon/utility-sass/templates/html/config' with (
    ...
);
```
...
```scss
@forward 'pkg:@maddimathon/utility-sass/templates/html/tokens' with (
    ...
);
```
...
@forward 'pkg:@maddimathon/utility-sass/templates/html';
...
@use 'pkg:@maddimathon/utility-sass/templates/html' as lib;
